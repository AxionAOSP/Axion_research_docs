...
| **System compositor** | `frameworks/native/libs/renderengine/skia/SkiaRenderEngine.cpp` | Converts media layers in SurfaceFlinger to clean RGB before Vulkan draws overlays. |
...
| **Screen capture / PixelCopy** | `frameworks/base/libs/hwui/Readback.cpp` | Converts video surfaces to clean RGB before reading them back. |
